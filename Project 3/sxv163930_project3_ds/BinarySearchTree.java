...
public class BinarySearchTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    public boolean compareStructure(BinarySearchTree<AnyType> that){
       ...
       BinaryNode thatroot = that.getRoot();
       return compareStructure(thatroot,root);
       
    }    
    private boolean compareStructure(BinaryNode thatroot,BinaryNode thisroot){
    
         if(thatroot == null && thisroot == null){
             return true;
         }
         if((thatroot == null && thisroot != null)||(thatroot != null && thisroot == null)){
            return false;
         }
         boolean l = compareStructure(thatroot.left,thisroot.left);
         boolean r = compareStructure(thatroot.right,thisroot.right);
...
//            t.printTree();
       ...
       //Testing compareStructure
           System.out.println("Check if given Tree has same structure as the original tree : "+t.compareStructure(DopleGanger));
